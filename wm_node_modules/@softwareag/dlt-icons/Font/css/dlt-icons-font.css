...
@font-face {
  ...
  src:
    url('../fonts/dlt-icons.ttf?bhgh7x') format('truetype'),
    url('../fonts/dlt-icons.woff?bhgh7x') format('woff'),
    url('../fonts/dlt-icons.svg?bhgh7x#dlt-icons') format('svg');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
...
.dlt-icon-drag:before {
  content: "\ea35";
}
.dlt-icon-compare:before {
  content: "\ea37";
}
...
.dlt-icon-volume-low:before, .dlt-icon-volume_low:before {
  content: "\ea25";
}
.dlt-icon-volume-high:before, .dlt-icon-volume_high:before {
  content: "\ea24";
}
.dlt-icon-volume-zero:before, .dlt-icon-volume_zero:before {
  content: "\ea26";
}
.dlt-icon-volume-mute:before, .dlt-icon-volume_mute:before {
  content: "\ea27";
}
.dlt-icon-error:before {
  content: "\e97c";
  color: var(--dlt-color-system-message-error, #d22d3d);
}
.dlt-icon-info:before {
  content: "\e97d";
  color: var(--dlt-color-system-message-info, #1776bf);
}
.dlt-icon-success:before {
  content: "\e97e";
  color: var(--dlt-color-system-message-success, #71a112);
}
.dlt-icon-warning:before {
  content: "\e97f";
  color: var(--dlt-color-system-message-warning, #e07800);
}
